...
I am a **third-year engineering student at ENSTA Paris** and a **Master’s student in Data Science at École Polytechnique (IP Paris)**, pursuing a **dual degree** through the academic partnership with:

- **ENIT – National Engineering School of Tunis**
- **ENSTA Paris – École Nationale Supérieure des Techniques Avancées**
...
- 🤖 **Machine Learning & Deep Learning** (MLP, CNN, RNN, Transformers)
- 🧠 **NLP & Large Language Models** (RAG, fine-tuning, prompt engineering)
- 📈 **Time Series & Spatio-Temporal Modeling**
- 🔗 **Extreme Value Theory & Dependence Modeling**  
  (Copulas, Pickands dependence function, spatial extremes)
- 🌍 **Climate, Risk & Energy Data**
...
### 🔗 Neural Estimation of Extreme-Value Copulas
...
### 📈 Time Series & Climate Risk Modeling
Spatio-temporal modeling of **meteorological and climate data (Météo-France)**, focusing on extreme events, dependence structures, and risk measures (VaR, TVaR).
